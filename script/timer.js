...
function timerCounting() {
	...
	if (
		(parseInt(timerHours.value) != 0) &
		(parseInt(timerMinutes.value) == 0) &
		(parseInt(timerSeconds.value) == 0)
	) {
		timerHours.value--;
		timerMinutes.value = 59;
		timerSeconds.value = 60;
	...
	if (
		(parseInt(timerMinutes.value) != 00) &
			(parseInt(timerSeconds.value) == 00) ||
		(parseInt(timerMinutes.value) != 00) & (timerSeconds.value == " ")
	) {
