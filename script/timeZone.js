...
function time() {
	...
	eua.textContent = `${horas(timeZoneEua)}:${formatter(minute)}:${formatter(
		second
	)}`;
	uk.textContent = `${horas(timeZoneUk)}:${formatter(minute)}:${formatter(
		second
	)}`;
	france.textContent = `${horas(timeZoneFr)}:${formatter(minute)}:${formatter(
		second
	)}`;
	japan.textContent = `${horas(timeZoneJapan)}:${formatter(minute)}:${formatter(
		second
	)}`;
	china.textContent = `${horas(timeZoneChina)}:${formatter(minute)}:${formatter(
		second
	)}`;
